...
<div class="main">
    <div class="container">
        ...
        <div class="t2" style="display: none">
            ...
            <a href="<?php echo e(url('merath')); ?>" class="btn merath_btn" onclick="PayHesapla()">حساب الميراث</a>
        </div>
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ivas_template_laravel5.8\resources\views/front/merath.blade.php ENDPATH**/ ?>