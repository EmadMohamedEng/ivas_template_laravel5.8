...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i><?php echo app('translator')->getFromJson('messages.add_user'); ?></h3>
                    <div class="box-tool">
                    ...
                    <form class="form-horizontal" action="<?php echo e(url('users')); ?>" method="post">
                    	...
                    	<div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls"> 
                                <input type="text" name="name" placeholder="<?php echo app('translator')->getFromJson('messages.users.user_name'); ?>" class="form-control input-lg" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls"> 
                                <input type="email" name="email" placeholder="<?php echo app('translator')->getFromJson('messages.users.email'); ?>" class="form-control input-lg" required> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls"> 
                                <input type="password" name="password" placeholder="<?php echo app('translator')->getFromJson('messages.users.password'); ?>" class="form-control input-lg" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 col-lg-2 control-label"><?php echo app('translator')->getFromJson('messages.users.phone'); ?> (optional)</label>
                            <div class="col-sm-9 col-lg-10 controls">
                                <input type="text" name="phone" placeholder="<?php echo app('translator')->getFromJson('messages.users.phone'); ?>" class="form-control input-lg">
                            </div>
                        </div>
                        <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/public_html/ivas_template_laravel5.8/resources/views/users/create.blade.php ENDPATH**/ ?>