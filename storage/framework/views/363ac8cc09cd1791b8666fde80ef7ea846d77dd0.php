                            ...
                            <table id="example" class="table table-striped dt-responsive" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <input type="text"  id="url_h<?php echo e($value->id); ?><?php echo e($content->id); ?><?php echo e($value->pivot->id); ?>" value="<?php echo e($value->pivot->url); ?>">
                                          <span class="btn"><?php echo e($value->name); ?></span>
                                          <span class="btn" onclick="x = document.getElementById('url_h<?php echo e($value->id); ?><?php echo e($content->id); ?><?php echo e($value->pivot->id); ?>'); x.select();document.execCommand('copy')"> <i class="fa fa-copy"></i> </span>
                                          <br>
                                        </td>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/public_html/ivas_template_laravel5.8/resources/views/content/show_post.blade.php ENDPATH**/ ?>