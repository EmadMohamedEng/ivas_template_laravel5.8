...
<head>
    ...
    header{
        background: <?php echo DB::table('settings')->where('key','like','%navbar%')->first()->value; ?>

    }
    footer{
        background: <?php echo DB::table('settings')->where('key','like','%footer%')->first()->value; ?>
            ...
            <div class="row">
                ...
                <div class="col-4 h_title">
                    <div class="page_title">
                        <img src="<?php echo e(url('').'/'. DB::table('settings')->where('key','like','%header_logo%')->first()->value); ?>" alt="islamic" onclick="gotohome()">
                    </div>
                </div>
