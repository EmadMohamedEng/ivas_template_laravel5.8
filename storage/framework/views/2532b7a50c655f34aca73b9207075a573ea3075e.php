                ...
                <div class="box box-black">
                    ...
                    <div class="box-content">
                        <div class="btn-toolbar pull-right">
                            <div class="btn-group">
                                <a class="btn btn-circle show-tooltip" title="" href="<?php echo e(url('sub_category/create')); ?>" data-original-title="Add new record"><i class="fa fa-plus"></i></a>
                                <?php
                            ...
                            <table id="example" class="table table-striped dt-responsive" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($value->cat->title); ?></td>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7.3\htdocs\ivas_template_laravel5.8\resources\views/sub_category/index.blade.php ENDPATH**/ ?>