                ...
                <div class="box box-black">
                    ...
                    <div class="box-content">
                        <div class="btn-toolbar pull-right">
                            <div class="btn-group">
                                <a class="btn btn-circle show-tooltip" title="" href="{{url('provider/create')}}" data-original-title="Add new record"><i class="fa fa-plus"></i></a>
                                <?php
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped dt-responsive" cellspacing="0" width="100%">
                                ...
                                <thead>
                                    <tr>
                                        <th style="width:18px"><input type="checkbox" onclick="select_all('providers')"></th>
                                        <th>id</th>
                                        <th>Title</th>
                                        <th>Image</th>
                                        <th >Action</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="visible-md visible-lg">
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-sm show-tooltip" href="{{url("provider/$value->id/edit")}}" title="Edit"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-sm show-tooltip btn-danger" onclick="return ConfirmDelete();" href="{{url("provider/$value->id/delete")}}" title="Delete"><i class="fa fa-trash"></i></a>
