                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="visible-md visible-lg">
                                            ...
                                            @if(\App\Category::where('provider_id',$value->id)->count()>0)
                                                <a class="btn btn-success show-tooltip" href="{{url("provider/$value->id")}}" title="category"><i class="fa fa-step-forward"></i></a>
