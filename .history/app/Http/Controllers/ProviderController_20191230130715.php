...
class ProviderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('category.index',compact('providers'));
    }
    ...
    public function store(Request $request)
    {
      ...
      $category = Provider::create($request->all());
    ...
    public function destroy($id)
    {
      ...
      if($category->image){
        $this->delete_image_if_exists(base_path('/uploads/provider/'.basename($category->image)));
      }
      $category->delete();
